...
function _isNativeReflectConstruct() {
  ...
  return (_isNativeReflectConstruct = function _isNativeReflectConstruct19() {
    return !!t;
  })();
}
function _getPrototypeOf(o) {
  _getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf.bind() : function _getPrototypeOf19(o2) {
...
function _isNativeReflectConstruct2() {
  ...
  return (_isNativeReflectConstruct2 = function _isNativeReflectConstruct19() {
    return !!t;
  })();
}
function _getPrototypeOf2(o) {
  _getPrototypeOf2 = Object.setPrototypeOf ? Object.getPrototypeOf.bind() : function _getPrototypeOf19(o2) {
    return o2.__proto__ || Object.getPrototypeOf(o2);
  };
...
function _isNativeReflectConstruct3() {
  ...
  return (_isNativeReflectConstruct3 = function _isNativeReflectConstruct19() {
    return !!t;
  })();
}
function _getPrototypeOf3(o) {
  _getPrototypeOf3 = Object.setPrototypeOf ? Object.getPrototypeOf.bind() : function _getPrototypeOf19(o2) {
    return o2.__proto__ || Object.getPrototypeOf(o2);
  };
...
function _isNativeReflectConstruct4() {
  ...
  return (_isNativeReflectConstruct4 = function _isNativeReflectConstruct19() {
    return !!t;
  })();
}
function _getPrototypeOf4(o) {
  _getPrototypeOf4 = Object.setPrototypeOf ? Object.getPrototypeOf.bind() : function _getPrototypeOf19(o2) {
    return o2.__proto__ || Object.getPrototypeOf(o2);
  };
...
function rgbSpline(spline) {
  return function(colors2) {
    var n = colors2.length, r2 = new Array(n), g = new Array(n), b = new Array(n), i, color2;
    for (i = 0; i < n; ++i) {
...
function _isNativeReflectConstruct5() {
  ...
  return (_isNativeReflectConstruct5 = function _isNativeReflectConstruct19() {
    return !!t;
  })();
}
function _getPrototypeOf5(o) {
  _getPrototypeOf5 = Object.setPrototypeOf ? Object.getPrototypeOf.bind() : function _getPrototypeOf19(o2) {
    return o2.__proto__ || Object.getPrototypeOf(o2);
  };
...
function areErrorsEqual(a2, b, state) {
  return a2.name === b.name && a2.message === b.message && a2.stack === b.stack && state.equals(a2.cause, b.cause, "cause", "cause", a2, b, state);
}
...
function areTypedArraysEqual(a2, b) {
  let index = a2.length;
  if (b.length !== index || a2.byteOffset !== b.byteOffset) {
    return false;
  }
  if (a2 instanceof Float64Array || a2 instanceof Float32Array || HAS_FLOAT_16_ARRAY && a2 instanceof Float16Array) {
    while (index-- > 0) {
      if (a2[index] !== b[index] && (a2[index] === a2[index] || b[index] === b[index])) {
        return false;
      }
    }
    return true;
...
function areUrlsEqual(a2, b) {
  ...
  return a2.protocol === b.protocol && a2.username === b.username && a2.password === b.password && a2.host === b.host && a2.pathname === b.pathname && a2.hash === b.hash && areSearchParamsEqual(a2.searchParams, b.searchParams);
}
function areSearchParamsEqual(a2, b) {
  const serializedA = a2.toString();
    ...
    return mapObject(function(key, val) {
      if (needContinue(val)) {
        return _objectSpread17(_objectSpread17({}, val), {}, {
          ...
          ["f"+"rom"]: alpha(val.from, nextStepVals[key].from, steps)
        });
      }
      return val;
    }, preVals);
...
var _excluded11 = ["children", "begin", "duration", "attributeName", "easing", "isActive", "steps", 'f'+'rom', "to", "canBegin", "onAnimationEnd", "shouldReAnimate", "onAnimationReStart"];
...
function _getPrototypeOf6(o) {
  _getPrototypeOf6 = Object.setPrototypeOf ? Object.getPrototypeOf.bind() : function _getPrototypeOf19(o2) {
    return o2.__proto__ || Object.getPrototypeOf(o2);
  };
...
Animate.propTypes = {
  ["f"+"rom"]: import_prop_types.default.oneOfType([import_prop_types.default.object, import_prop_types.default.string]),
...
var Rectangle = function Rectangle2(rectangleProps) {
  ...
  return /* @__PURE__ */ React17.createElement(es6_default, {
    ...
    return /* @__PURE__ */ React17.createElement(es6_default, {
      canBegin: totalLength > 0,
      ["f"+"rom"]: "0px ".concat(totalLength === -1 ? 1 : totalLength, "px"),
...
var getPolygonPath = function getPolygonPath2(radius, cx, cy, polarAngles) {
  ...
  polarAngles.forEach(function(angle, i) {
    var point4 = polarToCartesian(cx, cy, radius, angle);
    if (i) {
      path2 += "L ".concat(point4.x, ",").concat(point4.y);
    } else {
      path2 += "M ".concat(point4.x, ",").concat(point4.y);
    }
  });
  path2 += "Z";
  return path2;
...
var PolarAngles = function PolarAngles2(props) {
  ...
  return /* @__PURE__ */ React21.createElement("g", {
    ...
    return /* @__PURE__ */ React21.createElement("line", _extends16({}, polarAnglesProps, {
...
var ConcentricCircle = function ConcentricCircle2(props) {
  ...
  return /* @__PURE__ */ React21.createElement("circle", _extends16({}, concentricCircleProps, {
...
var ConcentricPolygon = function ConcentricPolygon2(props) {
  ...
  return /* @__PURE__ */ React21.createElement("path", _extends16({}, concentricPolygonProps, {
...
var ConcentricPath = function ConcentricPath2(props) {
  ...
  return /* @__PURE__ */ React21.createElement("g", {
    ...
    var key = i;
    if (gridType === "circle") return /* @__PURE__ */ React21.createElement(ConcentricCircle, _extends16({
      key
    }, props, {
      radius: entry,
      index: i
    }));
    return /* @__PURE__ */ React21.createElement(ConcentricPolygon, _extends16({
      key
    }, props, {
      radius: entry,
      index: i
...
var PolarGrid = function PolarGrid2(_ref) {
  ...
  return /* @__PURE__ */ React21.createElement("g", {
  ...
  }, /* @__PURE__ */ React21.createElement(PolarAngles, _extends16({
    cx,
    cy,
    innerRadius,
    outerRadius,
    gridType,
    radialLines
  }, props)), /* @__PURE__ */ React21.createElement(ConcentricPath, _extends16({
    cx,
    cy,
    innerRadius,
    outerRadius,
...
import React22, { PureComponent as PureComponent6 } from "react";
...
function _isNativeReflectConstruct7() {
  ...
  return (_isNativeReflectConstruct7 = function _isNativeReflectConstruct19() {
    return !!t;
  })();
}
function _getPrototypeOf7(o) {
  _getPrototypeOf7 = Object.setPrototypeOf ? Object.getPrototypeOf.bind() : function _getPrototypeOf19(o2) {
    return o2.__proto__ || Object.getPrototypeOf(o2);
  };
...
var PolarRadiusAxis = /* @__PURE__ */ (function(_PureComponent) {
  ...
  return _createClass8(PolarRadiusAxis2, [{
    ...
    value: function renderAxisLine() {
      ...
      return /* @__PURE__ */ React22.createElement("line", _extends17({
...
import React23, { PureComponent as PureComponent7 } from "react";
...
function _isNativeReflectConstruct8() {
  ...
  return (_isNativeReflectConstruct8 = function _isNativeReflectConstruct19() {
    return !!t;
  })();
}
function _getPrototypeOf8(o) {
  _getPrototypeOf8 = Object.setPrototypeOf ? Object.getPrototypeOf.bind() : function _getPrototypeOf19(o2) {
    return o2.__proto__ || Object.getPrototypeOf(o2);
  };
  ...
  return _createClass9(PolarAngleAxis2, [{
    ...
    value: function renderAxisLine() {
      ...
      if (axisLineType === "circle") {
        return /* @__PURE__ */ React23.createElement(Dot, _extends18({
      ...
      return /* @__PURE__ */ React23.createElement(Polygon, _extends18({
        className: "recharts-polar-angle-axis-line"
      }, props, {
        points
      }));
    ...
    value: function renderTicks() {
      ...
      var items = ticks2.map(function(entry, i) {
        ...
        var tickProps = _objectSpread23(_objectSpread23(_objectSpread23({
          textAnchor
        }, axisProps), {}, {
          stroke: "none",
          fill: stroke
        ...
        return /* @__PURE__ */ React23.createElement(Layer, _extends18({
          className: clsx_default("recharts-polar-angle-axis-tick", getTickClassName(tick)),
          key: "tick-".concat(entry.coordinate)
        }, adaptEventsOfChild(_this.props, entry, i)), tickLine && /* @__PURE__ */ React23.createElement("line", _extends18({
    ...
    value: function renderTickItem(option, props, value) {
      ...
      if (/* @__PURE__ */ React23.isValidElement(option)) {
        tickItem = /* @__PURE__ */ React23.cloneElement(option, props);
      } else if ((0, import_isFunction10.default)(option)) {
        tickItem = option(props);
      } else {
        tickItem = /* @__PURE__ */ React23.createElement(Text, _extends18({}, props, {
...
import React25, { isValidElement as isValidElement5, cloneElement as cloneElement5 } from "react";

// node_modules/recharts/es6/shape/Trapezoid.js
import React24, { useEffect as useEffect3, useRef as useRef3, useState as useState3 } from "react";
...
var Trapezoid = function Trapezoid2(props) {
  ...
  if (!isUpdateAnimationActive) {
    return /* @__PURE__ */ React24.createElement("g", null, /* @__PURE__ */ React24.createElement("path", _extends19({}, filterProps(trapezoidProps, true), {
      className: layerClass,
      d: getTrapezoidPath(x2, y2, upperWidth, lowerWidth, height)
    })));
  }
  return /* @__PURE__ */ React24.createElement(es6_default, {
    canBegin: totalLength > 0,
    ["f"+"rom"]: {
      upperWidth: 0,
      lowerWidth: 0,
    ...
    return /* @__PURE__ */ React24.createElement(es6_default, {
      ...
      duration: animationDuration,
      easing: animationEasing
    }, /* @__PURE__ */ React24.createElement("path", _extends19({}, filterProps(trapezoidProps, true), {
      className: layerClass,
...
function defaultPropTransformer(option, props) {
  return _objectSpread25(_objectSpread25({}, props), option);
}
...
function ShapeSelector(_ref) {
  ...
  switch (shapeType) {
    case "rectangle":
      return /* @__PURE__ */ React25.createElement(Rectangle, elementProps);
    case "trapezoid":
      return /* @__PURE__ */ React25.createElement(Trapezoid, elementProps);
    case "sector":
      return /* @__PURE__ */ React25.createElement(Sector, elementProps);
    case "symbols":
      if (isSymbolsProps(shapeType, elementProps)) {
        return /* @__PURE__ */ React25.createElement(Symbols, elementProps);
      }
      break;
    default:
      return null;
...
function Shape(_ref2) {
  ...
  var shape;
  if (/* @__PURE__ */ isValidElement5(option)) {
    shape = /* @__PURE__ */ cloneElement5(option, _objectSpread25(_objectSpread25({}, props), getPropsFromShapeOption(option)));
    ...
    shape = /* @__PURE__ */ React25.createElement(ShapeSelector, {
      shapeType,
...
import React26, { PureComponent as PureComponent8 } from "react";
...
function _isNativeReflectConstruct9() {
  ...
  return (_isNativeReflectConstruct9 = function _isNativeReflectConstruct19() {
    return !!t;
  })();
}
function _getPrototypeOf9(o) {
  _getPrototypeOf9 = Object.setPrototypeOf ? Object.getPrototypeOf.bind() : function _getPrototypeOf19(o2) {
    return o2.__proto__ || Object.getPrototypeOf(o2);
  };
...
var Radar = /* @__PURE__ */ (function(_PureComponent) {
  function Radar2() {
    ...
    _defineProperty28(_this, "handleMouseEnter", function(e) {
      var onMouseEnter = _this.props.onMouseEnter;
      if (onMouseEnter) {
        onMouseEnter(_this.props, e);
      }
    });
    _defineProperty28(_this, "handleMouseLeave", function(e) {
  ...
  return _createClass10(Radar2, [{
    ...
    value: function renderPolygonStatically(points) {
      ...
      var radar;
      if (/* @__PURE__ */ React26.isValidElement(shape)) {
        radar = /* @__PURE__ */ React26.cloneElement(shape, _objectSpread26(_objectSpread26({}, this.props), {}, {
          points
        }));
      } else if ((0, import_isFunction12.default)(shape)) {
        radar = shape(_objectSpread26(_objectSpread26({}, this.props), {}, {
          points
        }));
      } else {
        radar = /* @__PURE__ */ React26.createElement(Polygon, _extends20({}, filterProps(this.props, true), {
    ...
    value: function renderPolygonWithAnimation() {
      ...
      return /* @__PURE__ */ React26.createElement(es6_default, {
        begin: animationBegin,
        duration: animationDuration,
        isActive: isAnimationActive,
        easing: animationEasing,
    ...
    value: function renderDotItem(option, props) {
      ...
      if (/* @__PURE__ */ React26.isValidElement(option)) {
        ...
        dotItem = /* @__PURE__ */ React26.createElement(Dot, _extends20({}, dotProps, {
          key,
...
_defineProperty28(Radar, "displayName", "Radar");
_defineProperty28(Radar, "defaultProps", {
  angleAxisId: 0,
  radiusAxisId: 0,
  hide: false,
  activeDot: true,
...
_defineProperty28(Radar, "getComposedData", function(_ref2) {
  ...
  displayedData.forEach(function(entry, i) {
    ...
    points.push(_objectSpread26(_objectSpread26({}, polarToCartesian(cx, cy, radius, angle)), {}, {
      name,
      value,
      cx,
      cy,
  ...
  var baseLinePoints = [];
  if (isRange) {
    points.forEach(function(point4) {
      if (Array.isArray(point4.value)) {
        var baseValue = (0, import_first.default)(point4.value);
        var radius = (0, import_isNil9.default)(baseValue) ? void 0 : radiusAxis.scale(baseValue);
        baseLinePoints.push(_objectSpread26(_objectSpread26({}, point4), {}, {
          radius
        }, polarToCartesian(cx, cy, radius, point4.angle)));
      } else {
        baseLinePoints.push(point4);
      }
    });
  }
  return {
...
import React27, { PureComponent as PureComponent9, Children as Children3 } from "react";
...
function _isNativeReflectConstruct10() {
  ...
  return (_isNativeReflectConstruct10 = function _isNativeReflectConstruct19() {
    return !!t;
  })();
}
function _getPrototypeOf10(o) {
  _getPrototypeOf10 = Object.setPrototypeOf ? Object.getPrototypeOf.bind() : function _getPrototypeOf19(o2) {
    return o2.__proto__ || Object.getPrototypeOf(o2);
  };
...
var Brush = /* @__PURE__ */ (function(_PureComponent) {
  ...
  return _createClass11(Brush2, [{
    ...
    value: function renderText() {
      ...
      }, /* @__PURE__ */ React27.createElement(Text, _extends21({
        textAnchor: "end",
        verticalAnchor: "middle",
        x: Math.min(startX, endX) - offset,
        y: y2 + height / 2
      }, attrs), this.getTextOfTick(startIndex)), /* @__PURE__ */ React27.createElement(Text, _extends21({
        textAnchor: "start",
        verticalAnchor: "middle",
...
import React29, { PureComponent as PureComponent10 } from "react";
...
function typeguardBarRectangleProps(_ref, props) {
  var xProp = _ref.x, yProp = _ref.y, option = _objectWithoutProperties17(_ref, _excluded18);
...
function BarRectangle(props) {
  return /* @__PURE__ */ React28.createElement(Shape, _extends22({
    shapeType: "rectangle",
...
function _isNativeReflectConstruct11() {
  ...
  return (_isNativeReflectConstruct11 = function _isNativeReflectConstruct19() {
    return !!t;
  })();
}
function _getPrototypeOf11(o) {
  _getPrototypeOf11 = Object.setPrototypeOf ? Object.getPrototypeOf.bind() : function _getPrototypeOf19(o2) {
    return o2.__proto__ || Object.getPrototypeOf(o2);
  };
...
var Bar = /* @__PURE__ */ (function(_PureComponent) {
  function Bar2() {
    ...
    _this = _callSuper10(this, Bar2, [].concat(args));
  ...
  return _createClass12(Bar2, [{
    ...
    value: function renderRectanglesStatically(data) {
      ...
      return data && data.map(function(entry, i) {
        ...
        return /* @__PURE__ */ React29.createElement(Layer, _extends23({
    ...
    value: function renderBackground() {
      ...
      return data.map(function(entry, i) {
        ...
        return /* @__PURE__ */ React29.createElement(BarRectangle, _extends23({
...
var ScaleHelper = /* @__PURE__ */ (function() {
  ...
  return _createClass13(ScaleHelper2, [{
    key: "domain",
    get: function get7() {
...
function _isNativeReflectConstruct12() {
  ...
  return (_isNativeReflectConstruct12 = function _isNativeReflectConstruct19() {
    return !!t;
  })();
}
function _getPrototypeOf12(o) {
  _getPrototypeOf12 = Object.setPrototypeOf ? Object.getPrototypeOf.bind() : function _getPrototypeOf19(o2) {
    return o2.__proto__ || Object.getPrototypeOf(o2);
  };
...
var renderLine = function renderLine2(option, props) {
  ...
  if (/* @__PURE__ */ React31.isValidElement(option)) {
    ...
    line = /* @__PURE__ */ React31.createElement("line", _extends24({}, props, {
...
var ReferenceLine = /* @__PURE__ */ (function(_React$Component) {
  function ReferenceLine2() {
    _classCallCheck14(this, ReferenceLine2);
    return _callSuper11(this, ReferenceLine2, arguments);
  }
  _inherits12(ReferenceLine2, _React$Component);
  return _createClass14(ReferenceLine2, [{
    key: "render",
    value: function render() {
      return /* @__PURE__ */ React31.createElement(ReferenceLineImpl, this.props);
    }
  }]);
})(React31.Component);
...
function _isNativeReflectConstruct13() {
  ...
  return (_isNativeReflectConstruct13 = function _isNativeReflectConstruct19() {
    return !!t;
  })();
}
function _getPrototypeOf13(o) {
  _getPrototypeOf13 = Object.setPrototypeOf ? Object.getPrototypeOf.bind() : function _getPrototypeOf19(o2) {
    return o2.__proto__ || Object.getPrototypeOf(o2);
  };
...
var ReferenceDot = /* @__PURE__ */ (function(_React$Component) {
  function ReferenceDot2() {
    _classCallCheck15(this, ReferenceDot2);
    return _callSuper12(this, ReferenceDot2, arguments);
  }
  _inherits13(ReferenceDot2, _React$Component);
  return _createClass15(ReferenceDot2, [{
    key: "render",
    value: function render() {
...
_defineProperty35(ReferenceDot, "renderDot", function(option, props) {
  ...
  if (/* @__PURE__ */ React32.isValidElement(option)) {
    ...
    dot = /* @__PURE__ */ React32.createElement(Dot, _extends25({}, props, {
      cx: props.cx,
      cy: props.cy,
...
function _isNativeReflectConstruct14() {
  ...
  return (_isNativeReflectConstruct14 = function _isNativeReflectConstruct19() {
    return !!t;
  })();
}
function _getPrototypeOf14(o) {
  _getPrototypeOf14 = Object.setPrototypeOf ? Object.getPrototypeOf.bind() : function _getPrototypeOf19(o2) {
    return o2.__proto__ || Object.getPrototypeOf(o2);
  };
...
var ReferenceArea = /* @__PURE__ */ (function(_React$Component) {
  function ReferenceArea2() {
    _classCallCheck16(this, ReferenceArea2);
    return _callSuper13(this, ReferenceArea2, arguments);
  }
  _inherits14(ReferenceArea2, _React$Component);
  return _createClass16(ReferenceArea2, [{
    key: "render",
    value: function render() {
...
_defineProperty36(ReferenceArea, "renderRect", function(option, props) {
  ...
  if (/* @__PURE__ */ React33.isValidElement(option)) {
    ...
    rect = /* @__PURE__ */ React33.createElement(Rectangle, _extends26({}, props, {
...
import React34, { Component } from "react";
...
function _isNativeReflectConstruct15() {
  ...
  return (_isNativeReflectConstruct15 = function _isNativeReflectConstruct19() {
    return !!t;
  })();
}
function _getPrototypeOf15(o) {
  _getPrototypeOf15 = Object.setPrototypeOf ? Object.getPrototypeOf.bind() : function _getPrototypeOf19(o2) {
    return o2.__proto__ || Object.getPrototypeOf(o2);
  };
...
var CartesianAxis = /* @__PURE__ */ (function(_Component) {
  function CartesianAxis2(props) {
    ...
    _this = _callSuper14(this, CartesianAxis2, [props]);
    _this.state = {
      fontSize: "",
      letterSpacing: ""
    };
  ...
  return _createClass17(CartesianAxis2, [{
    key: "shouldComponentUpdate",
    value: function shouldComponentUpdate(_ref, nextState) {
      var viewBox = _ref.viewBox, restProps = _objectWithoutProperties19(_ref, _excluded20);
      var _this$props = this.props, viewBoxOld = _this$props.viewBox, restPropsOld = _objectWithoutProperties19(_this$props, _excluded25);
    ...
    value: function renderAxisLine() {
      ...
      return /* @__PURE__ */ React34.createElement("line", _extends27({}, props, {
    ...
    value: (
      ...
      function renderTicks(ticks2, fontSize, letterSpacing) {
        ...
        var items = finalTicks.map(function(entry, i) {
          ...
          return /* @__PURE__ */ React34.createElement(Layer, _extends27({
            className: "recharts-cartesian-axis-tick",
            key: "tick-".concat(entry.value, "-").concat(entry.coordinate, "-").concat(entry.tickCoord)
          }, adaptEventsOfChild(_this2.props, entry, i)), tickLine && /* @__PURE__ */ React34.createElement("line", _extends27({}, tickLineProps, lineCoord, {
    ...
    value: function renderTickItem(option, props, value) {
      ...
      if (/* @__PURE__ */ React34.isValidElement(option)) {
        tickItem = /* @__PURE__ */ React34.cloneElement(option, _objectSpread36(_objectSpread36({}, props), {}, {
          className: combinedClassName
        }));
      } else if ((0, import_isFunction18.default)(option)) {
        tickItem = option(_objectSpread36(_objectSpread36({}, props), {}, {
          className: combinedClassName
        }));
      } else {
        tickItem = /* @__PURE__ */ React34.createElement(Text, _extends27({}, props, {
...
function _isNativeReflectConstruct16() {
  ...
  return (_isNativeReflectConstruct16 = function _isNativeReflectConstruct19() {
    return !!t;
  })();
}
function _getPrototypeOf16(o) {
  _getPrototypeOf16 = Object.setPrototypeOf ? Object.getPrototypeOf.bind() : function _getPrototypeOf19(o2) {
    return o2.__proto__ || Object.getPrototypeOf(o2);
  };
...
function XAxisImpl(_ref) {
  ...
  return (
    ...
    /* @__PURE__ */ React35.createElement(CartesianAxis, _extends28({}, axisOptions, {
...
var XAxis = /* @__PURE__ */ (function(_React$Component) {
  function XAxis2() {
    _classCallCheck18(this, XAxis2);
    return _callSuper15(this, XAxis2, arguments);
  }
  _inherits16(XAxis2, _React$Component);
  return _createClass18(XAxis2, [{
    key: "render",
    value: function render() {
      return /* @__PURE__ */ React35.createElement(XAxisImpl, this.props);
    }
  }]);
})(React35.Component);
...
function _isNativeReflectConstruct17() {
  ...
  return (_isNativeReflectConstruct17 = function _isNativeReflectConstruct19() {
    return !!t;
  })();
}
function _getPrototypeOf17(o) {
  _getPrototypeOf17 = Object.setPrototypeOf ? Object.getPrototypeOf.bind() : function _getPrototypeOf19(o2) {
    return o2.__proto__ || Object.getPrototypeOf(o2);
  };
...
var YAxisImpl = function YAxisImpl2(_ref) {
  ...
  return (
    // @ts-expect-error the axisOptions type is not exactly what CartesianAxis is expecting.
    /* @__PURE__ */ React36.createElement(CartesianAxis, _extends29({}, axisOptions, {
      className: clsx_default("recharts-".concat(axisOptions.axisType, " ").concat(axisOptions.axisType), axisOptions.className),
      viewBox: {
        x: 0,
        y: 0,
...
var YAxis = /* @__PURE__ */ (function(_React$Component) {
  function YAxis2() {
    _classCallCheck19(this, YAxis2);
    return _callSuper16(this, YAxis2, arguments);
  }
  _inherits17(YAxis2, _React$Component);
  return _createClass19(YAxis2, [{
    key: "render",
    value: function render() {
      return /* @__PURE__ */ React36.createElement(YAxisImpl, this.props);
    }
  }]);
})(React36.Component);
...
import React37, { Component as Component4, cloneElement as cloneElement7, isValidElement as isValidElement7, forwardRef as forwardRef2 } from "react";
...
var AccessibilityManager = /* @__PURE__ */ (function() {
  function AccessibilityManager2() {
    ...
    _defineProperty41(this, "activeIndex", 0);
    _defineProperty41(this, "coordinateList", []);
    _defineProperty41(this, "layout", "horizontal");
  }
...
import { cloneElement as cloneElement6, createElement as createElement6, isValidElement as isValidElement6 } from "react";
...
function Cursor(props) {
  ...
  return /* @__PURE__ */ isValidElement6(elementPropsCursor) ? /* @__PURE__ */ cloneElement6(elementPropsCursor, cursorProps) : /* @__PURE__ */ createElement6(cursorComp, cursorProps);
}
...
function _isNativeReflectConstruct18() {
  ...
  return (_isNativeReflectConstruct18 = function _isNativeReflectConstruct19() {
    return !!t;
  })();
}
function _getPrototypeOf18(o) {
  _getPrototypeOf18 = Object.setPrototypeOf ? Object.getPrototypeOf.bind() : function _getPrototypeOf19(o2) {
    return o2.__proto__ || Object.getPrototypeOf(o2);
  };
...
var calculateOffset = function calculateOffset2(_ref5, prevLegendBBox) {
  ...
  var offsetV = Object.keys(xAxisMap).reduce(function(result, id) {
    ...
    var orientation = entry.orientation;
    if (!entry.mirror && !entry.hide) {
      return _objectSpread38(_objectSpread38({}, result), {}, _defineProperty43({}, orientation, (0, import_get5.default)(result, "".concat(orientation)) + entry.height));
    }
    return result;
  }, {
    top: margin.top || 0,
...
var generateCategoricalChart = function generateCategoricalChart2(_ref6) {
  ...
  var CategoricalChartWrapper = /* @__PURE__ */ (function(_Component) {
    function CategoricalChartWrapper2(_props) {
      ...
      _defineProperty43(_this, "eventEmitterSymbol", /* @__PURE__ */ Symbol("rechartsEventEmitter"));
      ...
      _defineProperty43(_this, "renderCursor", function(element) {
        ...
        return /* @__PURE__ */ React37.createElement(Cursor, {
          key,
          activeCoordinate,
          activePayload,
          activeTooltipIndex,
      ...
      _defineProperty43(_this, "renderPolarAxis", function(element, displayName, index) {
        ...
        return /* @__PURE__ */ cloneElement7(element, _objectSpread38(_objectSpread38({}, axisOption), {}, {
      ...
      _defineProperty43(_this, "renderLegend", function() {
        ...
        return /* @__PURE__ */ cloneElement7(item, _objectSpread38(_objectSpread38({}, otherProps), {}, {
          chartWidth: width,
          chartHeight: height,
          margin,
      ...
      _defineProperty43(_this, "renderGraphicChild", function(element, displayName, index) {
        ...
        var graphicalItem = /* @__PURE__ */ cloneElement7(element, _objectSpread38(_objectSpread38({}, item.props), itemEvents));
        ...
        if (hasActive) {
          if (activeTooltipIndex >= 0) {
            ...
            if (activeShape || activeBar) {
              ...
              return [/* @__PURE__ */ cloneElement7(element, _objectSpread38(_objectSpread38(_objectSpread38({}, item.props), itemEvents), {}, {
                activeIndex
              })), null, null];
            }
      ...
      _defineProperty43(_this, "renderCustomized", function(element, displayName, index) {
        return /* @__PURE__ */ cloneElement7(element, _objectSpread38(_objectSpread38({
    ...
    return _createClass21(CategoricalChartWrapper2, [{
      ...
      value: function renderClipPath() {
        ...
        return /* @__PURE__ */ React37.createElement("defs", null, /* @__PURE__ */ React37.createElement("clipPath", {
          id: clipPathId
      ...
      value: function render() {
        ...
        var _this$props6 = this.props, children = _this$props6.children, className = _this$props6.className, width = _this$props6.width, height = _this$props6.height, style = _this$props6.style, compact = _this$props6.compact, title = _this$props6.title, desc = _this$props6.desc, others = _objectWithoutProperties20(_this$props6, _excluded26);
        var attrs = filterProps(others, false);
        if (compact) {
          return /* @__PURE__ */ React37.createElement(ChartLayoutContextProvider, {
            state: this.state,
            width: this.props.width,
            height: this.props.height,
            clipPathId: this.clipPathId
          }, /* @__PURE__ */ React37.createElement(Surface, _extends30({}, attrs, {
            width,
            height,
            title,
            desc
        ...
        return /* @__PURE__ */ React37.createElement(ChartLayoutContextProvider, {
          ...
          height: this.props.height,
          clipPathId: this.clipPathId
        }, /* @__PURE__ */ React37.createElement("div", _extends30({
  ...
  _defineProperty43(CategoricalChartWrapper, "renderActiveDot", function(option, props, key) {
    ...
    if (/* @__PURE__ */ isValidElement7(option)) {
      ...
      dot = /* @__PURE__ */ React37.createElement(Dot, props);
    }
  ...
  var CategoricalChart = /* @__PURE__ */ forwardRef2(function CategoricalChart2(props, ref) {
    return /* @__PURE__ */ React37.createElement(CategoricalChartWrapper, _extends30({}, props, {
      ref
    }));
  });
...
function useResizable(opts) {
  const { initial, min: min3, max: max3, storageKey } = opts;
  const [width, setWidth] = useState4(() => {
    if (storageKey) {
      const saved = localStorage.getItem(storageKey);
      if (saved) {
        const v = parseInt(saved, 10);
        if (!isNaN(v) && v >= min3 && v <= max3) return v;
      }
    }
    return initial;
  });
  ...
  const startWidth = useRef4(0);
  useEffect4(() => {
    const onMove = (e) => {
      if (!dragging.current) return;
      e.preventDefault();
      const delta = e.clientX - startX.current;
      const next = Math.min(max3, Math.max(min3, startWidth.current - delta));
      setWidth(next);
    };
    const onUp = () => {
      if (dragging.current) {
...
function NewsPanel(props) {
  ...
  const isTracked = (id) => trackedIds.has(id);
  const [priceThreshold, setPriceThreshold] = useState5(5);
  const [priceDays, setPriceDays] = useState5(7);
  const _nowSec = Date.now() / 1e3;
  const filteredPriceChanges = (news?.price_changes || []).filter((pc) => {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsx("span", { className: "news-sash-hairline" }),
          /* @__PURE__ */ jsx("span", { className: "news-sash-hover-band" })
        ]
      }
    ),
    /* @__PURE__ */ jsxs(
          ...
          loading ? /* @__PURE__ */ jsx("p", { style: { fontSize: 13, color: "var(--ui-text-tertiary)" }, children: t.news.loading }) : !news ? /* @__PURE__ */ jsx("p", { style: { fontSize: 13, color: "var(--ui-text-tertiary)" }, children: t.news.none }) : /* @__PURE__ */ jsxs("div", { style: { display: "flex", flexDirection: "column", gap: 20 }, children: [
              ...
              /* @__PURE__ */ jsx("div", { style: { display: "flex", flexDirection: "column", gap: 8 }, children: processedPromotions.map((p) => /* @__PURE__ */ jsxs("div", { style: {
                ...
                /* @__PURE__ */ jsxs("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "flex-start" }, children: [
                  /* @__PURE__ */ jsxs("div", { style: { display: "flex", alignItems: "center", gap: 6, flexWrap: "wrap" }, children: [
                    ...
                    /* @__PURE__ */ jsxs("span", { style: { background: "var(--ui-red)", color: "var(--ui-bg-editor)", padding: "1px 5px", borderRadius: 3, fontWeight: 700, fontSize: 10 }, children: [
                      "🔻 ",
                      p.discount_text
                    ] })
                  ] }),
                  ...
                  /* @__PURE__ */ jsx(
                    "button",
                    {
                      ...
                      style: {
                        ...
                        padding: "3px 8px",
                        borderRadius: 4,
                        cursor: isTracked(p.id) ? "default" : "pointer",
                        fontWeight: 600,
            ...
            news.price_changes && news.price_changes.length > 0 && /* @__PURE__ */ jsxs("div", { children: [
              ...
              /* @__PURE__ */ jsxs("div", { style: { display: "flex", flexDirection: "column", gap: 8 }, children: [
                filteredPriceChanges.map((pc) => {
                  const v1 = pc.percent_1d;
                  const v7 = pc.percent_7d;
                  const pick = v1 != null && Math.abs(v1) >= priceThreshold ? { v: v1, lbl: "24h" } : { v: v7, lbl: "7j" };
                  return /* @__PURE__ */ jsxs("div", { style: { background: "var(--ui-bg-tertiary)", border: "1px solid color-mix(in srgb, var(--ui-blue) 10%, transparent)", borderRadius: "var(--radius-sm)", padding: "8px 10px", fontSize: 12 }, children: [
                    /* @__PURE__ */ jsxs("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center" }, children: [
                      /* @__PURE__ */ jsx("b", { children: pc.id.split("/").pop() }),
                      /* @__PURE__ */ jsxs("span", { style: { color: pick.v <= 0 ? "var(--ui-green)" : "var(--ui-red)", fontWeight: 700, fontSize: 11 }, children: [
                        pick.v <= 0 ? `🔻 ${pick.v}%` : `🔺 +${pick.v}%`,
                        " (",
                        pick.lbl,
                        ")"
                      ] })
                    ...
                    /* @__PURE__ */ jsxs("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center", marginTop: 4 }, children: [
                      /* @__PURE__ */ jsxs("span", { style: { fontSize: 10, color: "var(--ui-text-tertiary)" }, children: [
                        "Date : ",
                ...
                filteredPriceChanges.length === 0 && /* @__PURE__ */ jsxs("div", { style: { fontSize: 11, color: "var(--ui-text-tertiary)" }, children: [
                  "Aucune variation ≥ ",
                  priceThreshold,
                  "% sur ",
                  priceDays,
                ...
                priceDays < 90 && /* @__PURE__ */ jsxs("button", { onClick: () => setPriceDays((prev) => prev + 7), style: {
                  marginTop: 4,
                  padding: "6px 10px",
            ...
            /* @__PURE__ */ jsxs("div", { children: [
                ...
                /* @__PURE__ */ jsxs("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between" }, children: [
                  ...
                  /* @__PURE__ */ jsxs(
                    "select",
                    {
                      ...
                      onChange: (e) => {
                        setNewsTimeWindow(e.target.value);
                        setNewsVisibleLimit(() => 8);
                      },
              ...
              processedNewModels.length === 0 ? /* @__PURE__ */ jsx("p", { style: { fontSize: 11, color: "var(--ui-text-tertiary)", fontStyle: "italic" }, children: t.news.noNewModels }) : /* @__PURE__ */ jsxs("div", { style: { display: "flex", flexDirection: "column", gap: 8 }, children: [
                processedNewModels.slice(0, newsVisibleLimit).map((nm) => /* @__PURE__ */ jsxs("div", { style: {
                  ...
                  /* @__PURE__ */ jsxs("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "flex-start" }, children: [
                    /* @__PURE__ */ jsxs("div", { children: [
                      /* @__PURE__ */ jsx("b", { children: nm.name || nm.id.split("/").pop() }),
                      /* @__PURE__ */ jsxs("div", { style: { fontSize: 10, color: "var(--ui-text-tertiary)" }, children: [
                        fmtDate2(nm.created),
                        " · ",
                        fmtCtx2(nm.context_length),
                        " ctx"
                      ] })
                    ] }),
                    /* @__PURE__ */ jsxs("div", { style: { textAlign: "right" }, children: [
                      /* @__PURE__ */ jsx("span", { style: { fontWeight: 800, color: nm._isChallenger ? "var(--ui-orange)" : "var(--ui-text-secondary)", fontSize: 12 }, children: nm._roundedScore > 0 ? `${nm._roundedScore}/100` : "–" }),
                      nm._isChallenger && /* @__PURE__ */ jsx("div", { style: { fontSize: 9, background: "var(--ui-orange)", color: "var(--ui-bg-editor)", padding: "1px 4px", borderRadius: 3, fontWeight: 700, marginTop: 1 }, children: "🔥 Top 3 !" })
                    ] })
                  ] }),
                  /* @__PURE__ */ jsxs("div", { style: { fontSize: 11, color: "var(--ui-text-tertiary)", marginTop: 4, display: "flex", justifyContent: "space-between", alignItems: "center" }, children: [
                    /* @__PURE__ */ jsxs("span", { children: [
                      fmtPrice2(nm.prompt_price),
                      " / ",
                      ...
                      /* @__PURE__ */ jsx(
                        "button",
                        {
                          ...
                          style: {
                            ...
                            padding: "3px 8px",
                            borderRadius: 4,
                            cursor: isTracked(nm.id) ? "default" : "pointer",
                            fontWeight: 600,
                ...
                newsVisibleLimit < processedNewModels.length && /* @__PURE__ */ jsxs("button", { onClick: () => setNewsVisibleLimit((prev) => prev + 10), style: {
                  marginTop: 4,
                  padding: "6px 10px",
                  background: "var(--ui-bg-tertiary)",
                  border: "1px solid var(--ui-stroke-secondary)",
                  ...
                  "➕ Afficher plus (",
                  processedNewModels.length - newsVisibleLimit,
                  " restants)"
                ] })
              ] })
            ] })
...
function api(path2, opts) {
  if (restFn) return restFn(path2, opts);
  return fetch(`/api${path2}`, opts).then((r2) => {
    if (!r2.ok) return r2.json().then((e) => {
...
var LOCALES = {
  en: {
    ...
    modal: {
      ...
      deleteConfirm: (name) => `Delete the '${name}' tracking profile?`,
  ...
  fr: {
    ...
    refresh: "Rafraîchir",
    nVisible: (n, extra) => `${n} visibles${extra}`,
    nHidden: (n) => ` (+${n} masqués)`,
    ...
    modal: {
      ...
      deleteConfirm: (name) => `Supprimer le profil de suivi '${name}' ?`,
...
function bindI18n(t, template, prefix2 = "") {
  const out = {};
  for (const [key, value] of Object.entries(template)) {
    const path2 = prefix2 ? `${prefix2}.${key}` : key;
    out[key] = typeof value === "function" ? (...args) => t(path2, ...args) : value && typeof value === "object" ? bindI18n(t, value, path2) : t(path2);
  }
  return out;
}
function useLeaderboardI18n() {
  const t = usePluginI18n(ID);
  return useMemo3(() => bindI18n(t, LOCALES.en), [t]);
}
...
function fmtCtx(v) {
  ...
  if (v >= 1e6) {
    ...
    return v % 1e6 === 0 ? `${millions}M` : `+${Math.floor(millions)}M`;
  }
  if (v >= 1e3) return `${Math.round(v / 1e3)}k`;
  return `${v}`;
}
function buildModelTooltip(m) {
  const inMod = m.input_modalities && m.input_modalities.length > 0 ? m.input_modalities.map((s2) => s2.charAt(0).toUpperCase() + s2.slice(1)).join(", ") : m.has_vision ? "Text, Image" : "Text";
  const outMod = m.output_modalities && m.output_modalities.length > 0 ? m.output_modalities.map((s2) => s2.charAt(0).toUpperCase() + s2.slice(1)).join(", ") : "Text";
  const lines = [
...
function fmtDate(ts) {
  if (!ts) return "–";
  return new Date(ts * 1e3).toLocaleDateString("fr-FR", { day: "2-digit", month: "short", year: "2-digit" });
}
var providerIcons = {
  anthropic: "🅐",
  openai: "🅞",
...
function providerIcon(id) {
  for (const [k2, v] of Object.entries(providerIcons)) if (id.split("/")[0].includes(k2)) return v;
  return "🤖";
}
function providerName(id) {
  const p = id.split("/")[0];
  for (const k2 of Object.keys(providerIcons)) if (p.includes(k2)) return k2.charAt(0).toUpperCase() + k2.slice(1);
  return p;
}
var colors = [
  "var(--ui-purple)",
  ...
  "#ba68c8",
  "#4db6ac",
  "var(--ui-bg-editor)176"
];
var S = {
  wrap: { fontFamily: "var(--dt-font-sans)", color: "var(--ui-text-primary)", padding: "8px 14px" },
  flexRow: { display: "flex", justifyContent: "space-between", alignItems: "center", gap: 8, flexWrap: "wrap" },
  gap: { display: "flex", gap: 8, alignItems: "center" },
  table: { width: "100%", borderCollapse: "collapse", fontSize: 12 },
  th: { textAlign: "left", padding: "6px 8px", background: "var(--ui-bg-tertiary)", borderBottom: "2px solid var(--ui-stroke-primary)", whiteSpace: "nowrap", color: "var(--ui-text-secondary)", fontWeight: 700 },
  trEven: { background: "var(--ui-bg-editor)" },
  trOdd: { background: "var(--ui-row-hover-background)" },
  td: { padding: "5px 8px", borderBottom: "1px solid var(--ui-stroke-tertiary)" },
  searchRow: { padding: "6px 10px", borderBottom: "1px solid var(--ui-stroke-tertiary)", fontSize: 13 },
  tabBtn: (active) => ({
    padding: "8px 18px",
    border: "none",
...
function App() {
  ...
  const [hiddenIds, setHiddenIds] = useState6(/* @__PURE__ */ new Set());
  const [radarHidden, setRadarHidden] = useState6(/* @__PURE__ */ new Set());
  ...
  const [news, setNews] = useState6(null);
  const [loadingNews, setLoadingNews] = useState6(false);
  const [newsSortBy, setNewsSortBy] = useState6("date");
  const [newsTimeWindow, setNewsTimeWindow] = useState6("1m");
  const [newsVisibleLimit, setNewsVisibleLimit] = useState6(8);
  useEffect5(() => {
  ...
  const [autoFillMsg, setAutoFillMsg] = useState6("");
  ...
  const deleteCurrentProfile = () => {
    ...
    setSavingProfile(true);
    api(`/profiles/${encodeURIComponent(pid)}`, { method: "DELETE" }).then(() => {
      ...
      setModalOpen(false);
    }).catch((err) => alert(err.message || i18n.modal.saveError)).finally(() => setSavingProfile(false));
  };
  const sortFns = {
    label: (a2, b) => a2.label.localeCompare(b.label),
    context_length: (a2, b) => (a2.context_length || 0) - (b.context_length || 0),
    prompt_price: (a2, b) => (a2.prompt_price ?? Infinity) - (b.prompt_price ?? Infinity),
    completion_price: (a2, b) => (a2.completion_price ?? Infinity) - (b.completion_price ?? Infinity),
    cache_read_price: (a2, b) => (a2.cache_read_price ?? Infinity) - (b.cache_read_price ?? Infinity),
    intelligence_index: (a2, b) => (a2.intelligence_index ?? -1) - (b.intelligence_index ?? -1),
    coding_index: (a2, b) => (a2.coding_index ?? -1) - (b.coding_index ?? -1),
    agentic_index: (a2, b) => (a2.agentic_index ?? -1) - (b.agentic_index ?? -1),
    open_weights: (a2, b) => (a2.open_weights ? 1 : 0) - (b.open_weights ? 1 : 0),
    tools: (a2, b) => ((a2.supported_parameters || []).includes("tools") ? 1 : 0) - ((b.supported_parameters || []).includes("tools") ? 1 : 0),
    has_vision: (a2, b) => (a2.has_vision ? 1 : 0) - (b.has_vision ? 1 : 0)
  };
  ...
  scoredModels.forEach((m) => {
    scoreMap[m.id] = m._score;
  });
  const sortedModels = useMemo4(() => {
    if (sortCol && sortFns[sortCol]) {
      const sorted = [...models].sort(sortFns[sortCol]);
      return sortAsc ? sorted : sorted.reverse();
    }
    return [...models].sort((a2, b) => (scoreMap[b.id] ?? 0) - (scoreMap[a2.id] ?? 0));
  }, [models, sortCol, sortAsc, scoreMap]);
  const processedNewModels = useMemo4(() => {
    ...
    if (newsSortBy === "score") {
      list.sort((a2, b) => b._score - a2._score);
    } else {
      list.sort((a2, b) => (b.created || 0) - (a2.created || 0));
    }
    return list;
  ...
  const byPriceIn = [...active].sort((a2, b) => (a2.prompt_price ?? 0) - (b.prompt_price ?? 0));
  const byPriceOut = [...active].sort((a2, b) => (a2.completion_price ?? 0) - (b.completion_price ?? 0));
  ...
  return /* @__PURE__ */ jsxs2("div", { style: S.wrap, children: [
        ...
        loading ? /* @__PURE__ */ jsx2("p", { children: i18n.loading }) : /* @__PURE__ */ jsxs2(Fragment2, { children: [
          /* @__PURE__ */ jsxs2("div", { style: { marginBottom: 24, padding: 16, background: "var(--ui-row-hover-background)", borderRadius: 8, border: "1px solid var(--ui-stroke-tertiary)" }, children: [
            /* @__PURE__ */ jsxs2("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 8 }, children: [
              /* @__PURE__ */ jsx2("h3", { style: { margin: 0, color: "var(--ui-text-primary)" }, children: i18n.ranking(currentProfile.name) }),
              /* @__PURE__ */ jsxs2("span", { style: { display: "flex", gap: 10, alignItems: "center" }, children: [
                /* @__PURE__ */ jsx2("span", { style: { fontSize: 12, color: "var(--ui-text-tertiary)" }, children: i18n.customCriteria }),
                /* @__PURE__ */ jsx2(
                  "button",
                  {
                    ...
                    children: i18n.editCriteria
                  }
                )
              ] })
            ] }),
            /* @__PURE__ */ jsx2("div", { style: { display: "flex", gap: 16, flexWrap: "wrap" }, children: scoredModels.slice(0, 5).map((m) => /* @__PURE__ */ jsxs2(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxs2("div", { style: { fontWeight: 700, fontSize: 13, display: "flex", alignItems: "center", justifyContent: "space-between" }, children: [
                    /* @__PURE__ */ jsxs2("span", { children: [
                      m._rank === 1 ? "🥇" : m._rank === 2 ? "🥈" : m._rank === 3 ? "🥉" : `#${m._rank}`,
                      " ",
                      providerIcon(m.id),
                      " ",
                      m.label
                    ] }),
                    /* @__PURE__ */ jsx2("span", { style: { fontSize: 10, background: "var(--ui-bg-tertiary)", padding: "1px 4px", borderRadius: 3, color: "var(--ui-text-secondary)" }, children: fmtCtx(m.context_length) })
                  ] }),
                  /* @__PURE__ */ jsxs2("div", { style: { fontSize: 18, fontWeight: 800, color: "var(--ui-orange)", marginTop: 2 }, children: [
                    m._score.toFixed(0),
                    "/100"
                  ] }),
                  /* @__PURE__ */ jsxs2("div", { style: { fontSize: 11, color: "var(--ui-text-tertiary)", marginTop: 2, display: "flex", justifyContent: "space-between" }, children: [
                    /* @__PURE__ */ jsxs2("span", { children: [
                      "in:",
                      fmtPrice(m.prompt_price)
                    ] }),
                    /* @__PURE__ */ jsxs2("span", { children: [
                      "out:",
                      fmtPrice(m.completion_price)
                    ] })
                  ] })
                ]
              },
          ...
          /* @__PURE__ */ jsx2("div", { style: { overflowX: "auto", marginBottom: 24, border: "1px solid var(--ui-stroke-tertiary)", borderRadius: 8 }, children: /* @__PURE__ */ jsxs2("table", { style: S.table, children: [
            /* @__PURE__ */ jsx2("thead", { children: /* @__PURE__ */ jsxs2("tr", { children: [
              ...
              /* @__PURE__ */ jsxs2("th", { style: { ...S.th, cursor: "pointer", userSelect: "none" }, onClick: () => toggleSort("label"), children: [
                i18n.table.model,
                sortArrow("label")
              ] }),
              /* @__PURE__ */ jsxs2("th", { style: { ...S.th, textAlign: "center", cursor: "pointer" }, onClick: () => toggleSort("context_length"), children: [
                i18n.table.context,
                sortArrow("context_length")
              ] }),
              /* @__PURE__ */ jsxs2("th", { style: { ...S.th, textAlign: "right", cursor: "pointer" }, onClick: () => toggleSort("prompt_price"), children: [
                "$ in",
                sortArrow("prompt_price")
              ] }),
              /* @__PURE__ */ jsxs2("th", { style: { ...S.th, textAlign: "right", cursor: "pointer" }, onClick: () => toggleSort("completion_price"), children: [
                "$ out",
                sortArrow("completion_price")
              ] }),
              /* @__PURE__ */ jsxs2("th", { style: { ...S.th, textAlign: "right", cursor: "pointer" }, onClick: () => toggleSort("cache_read_price"), children: [
                "$ cache",
                sortArrow("cache_read_price")
              ] }),
              /* @__PURE__ */ jsxs2("th", { style: { ...S.th, textAlign: "center", cursor: "pointer" }, onClick: () => toggleSort("intelligence_index"), children: [
                "Intel.",
                sortArrow("intelligence_index")
              ] }),
              /* @__PURE__ */ jsxs2("th", { style: { ...S.th, textAlign: "center", cursor: "pointer" }, onClick: () => toggleSort("coding_index"), children: [
                "Coding",
                sortArrow("coding_index")
              ] }),
              /* @__PURE__ */ jsxs2("th", { style: { ...S.th, textAlign: "center", cursor: "pointer" }, onClick: () => toggleSort("agentic_index"), children: [
                "Agentic",
              ...
              /* @__PURE__ */ jsxs2("th", { style: { ...S.th, textAlign: "center", cursor: "pointer" }, onClick: () => toggleSort("open_weights"), children: [
                "Open",
                sortArrow("open_weights")
              ] }),
              /* @__PURE__ */ jsx2("th", { style: { ...S.th, textAlign: "center" }, children: "Taille" }),
              /* @__PURE__ */ jsx2("th", { style: { ...S.th, textAlign: "center" }, children: "GPU Q4" }),
              /* @__PURE__ */ jsxs2("th", { style: { ...S.th, textAlign: "center", cursor: "pointer" }, onClick: () => toggleSort("tools"), children: [
                "Tools",
                sortArrow("tools")
              ] }),
            ...
            /* @__PURE__ */ jsx2("tbody", { children: sortedModels.filter((m) => {
              ...
              return /* @__PURE__ */ jsxs2("tr", { style: { ...i % 2 === 0 ? S.trEven : S.trOdd, opacity: hiddenIds.has(m.id) ? 0.35 : m.available ? 1 : 0.4 }, children: [
                /* @__PURE__ */ jsx2("td", { style: { ...S.td, textAlign: "center", fontSize: 16 }, title: providerName(m.id), children: providerIcon(m.id) }),
                /* @__PURE__ */ jsxs2("td", { style: S.td, children: [
                  /* @__PURE__ */ jsx2("b", { children: m.label }),
                  /* @__PURE__ */ jsx2("div", { style: { fontSize: 10, color: "var(--ui-text-tertiary)" }, children: m.id })
                ] }),
                /* @__PURE__ */ jsx2("td", { style: { ...S.td, textAlign: "right" }, title: `${(m.context_length || 0).toLocaleString()} tokens`, children: fmtCtx(m.context_length) }),
                /* @__PURE__ */ jsx2("td", { style: { ...S.td, textAlign: "right" }, children: fmtPrice(m.prompt_price) }),
                /* @__PURE__ */ jsx2("td", { style: { ...S.td, textAlign: "right" }, children: fmtPrice(m.completion_price) }),
                /* @__PURE__ */ jsx2("td", { style: { ...S.td, textAlign: "right", color: m.cache_read_price ? "var(--ui-blue)" : "var(--ui-text-quaternary)" }, children: m.cache_read_price != null ? fmtPrice(m.cache_read_price) : "–" }),
                /* @__PURE__ */ jsx2("td", { style: { ...S.td, textAlign: "center" }, children: fmtIdx(m.intelligence_index) }),
                ...
                /* @__PURE__ */ jsx2("td", { style: { ...S.td, textAlign: "center", fontSize: 11 }, children: m.gpu ? /* @__PURE__ */ jsxs2("span", { title: `Q8: ${m.gpu.vram_q8_gb}GB, FP16: ${m.gpu.vram_fp16_gb}GB`, children: [
                  m.gpu.vram_q4_gb,
                  "GB",
                  m.gpu.fits_64gb ? " ✓" : ""
                ] }) : "-" }),
                ...
                /* @__PURE__ */ jsxs2("td", { style: { ...S.td, textAlign: "center", fontWeight: 700, background: top3 ? "var(--ui-bg-editor)3e0" : void 0 }, children: [
                  /* @__PURE__ */ jsxs2("span", { title: `Score ${currentProfile.name}: ${sc}`, style: { color: top3 ? "var(--ui-orange)" : sc > 50 ? "var(--ui-green)" : "var(--ui-text-tertiary)" }, children: [
                    rankStr,
                    top3 && /* @__PURE__ */ jsx2("span", { style: { fontSize: 10, marginLeft: 2 }, children: "🥇" })
                  ] }),
                  /* @__PURE__ */ jsx2("div", { style: { fontSize: 10, color: "var(--ui-text-quaternary)" }, children: sc != null ? `${Math.round(sc)}` : "" })
                ] }),
                /* @__PURE__ */ jsxs2("td", { style: { ...S.td, whiteSpace: "nowrap", textAlign: "right" }, children: [
                  /* @__PURE__ */ jsx2(
                    "button",
                    {
          ...
          active.length >= 2 && /* @__PURE__ */ jsxs2(Fragment2, { children: [
            /* @__PURE__ */ jsx2("h2", { style: { marginTop: 32, color: "var(--ui-text-primary)" }, children: "Prix ($ / million tokens)" }),
            /* @__PURE__ */ jsxs2("div", { style: { display: "flex", gap: 24, flexWrap: "wrap" }, children: [
              /* @__PURE__ */ jsxs2("div", { style: { flex: 1, minWidth: 360 }, children: [
                /* @__PURE__ */ jsx2("h3", { style: { fontSize: 14, color: "var(--ui-text-tertiary)" }, children: "Input (moins cher d'abord)" }),
                /* @__PURE__ */ jsx2(ResponsiveContainer, { width: "100%", height: 250, children: /* @__PURE__ */ jsxs2(BarChart, { data: byPriceIn, children: [
                  /* @__PURE__ */ jsx2(XAxis, { dataKey: "label", fontSize: 11 }),
                  /* @__PURE__ */ jsx2(Tooltip, { formatter: (v) => fmtPrice(v) }),
                  /* @__PURE__ */ jsx2(Bar, { dataKey: "prompt_price", fill: "var(--ui-purple)", name: "$ / M tokens", isAnimationActive: false })
                ] }) })
              ] }),
              /* @__PURE__ */ jsxs2("div", { style: { flex: 1, minWidth: 360 }, children: [
                /* @__PURE__ */ jsx2("h3", { style: { fontSize: 14, color: "var(--ui-text-tertiary)" }, children: "Output (moins cher d'abord)" }),
                /* @__PURE__ */ jsx2(ResponsiveContainer, { width: "100%", height: 250, children: /* @__PURE__ */ jsxs2(BarChart, { data: byPriceOut, children: [
                  /* @__PURE__ */ jsx2(XAxis, { dataKey: "label", fontSize: 11 }),
                  /* @__PURE__ */ jsx2(Tooltip, { formatter: (v) => fmtPrice(v) }),
                  /* @__PURE__ */ jsx2(Bar, { dataKey: "completion_price", fill: "#82ca9d", name: "$ / M tokens", isAnimationActive: false })
                ] }) })
              ] })
            ] }),
            /* @__PURE__ */ jsx2("h2", { style: { marginTop: 32, color: "var(--ui-text-primary)" }, children: "Benchmarks Intelligence (Artificial Analysis)" }),
            /* @__PURE__ */ jsx2("div", { style: { display: "flex", gap: 24, flexWrap: "wrap" }, children: [
              ...
              const sorted = [...active].filter((m) => m[bm.k] != null).sort((a2, b) => (b[bm.k] ?? 0) - (a2[bm.k] ?? 0));
              return /* @__PURE__ */ jsxs2("div", { style: { flex: 1, minWidth: 260 }, children: [
                /* @__PURE__ */ jsx2("h3", { style: { fontSize: 14, color: "var(--ui-text-tertiary)" }, children: bm.label }),
                /* @__PURE__ */ jsx2(ResponsiveContainer, { width: "100%", height: 250, children: /* @__PURE__ */ jsxs2(BarChart, { data: sorted, children: [
                  /* @__PURE__ */ jsx2(XAxis, { dataKey: "label", fontSize: 11 }),
                  /* @__PURE__ */ jsx2(Tooltip, {}),
                  /* @__PURE__ */ jsx2(Bar, { dataKey: bm.k, fill: bm.color, name: bm.label, isAnimationActive: false })
                ] }) })
              ] }, bm.k);
            }) }),
            /* @__PURE__ */ jsx2("h2", { style: { marginTop: 32, color: "var(--ui-text-primary)" }, children: "Contexte (tokens)" }),
            /* @__PURE__ */ jsx2(ResponsiveContainer, { width: "100%", height: 300, children: /* @__PURE__ */ jsxs2(BarChart, { data: byCtx, layout: "vertical", children: [
              /* @__PURE__ */ jsx2(XAxis, { type: "number", fontSize: 11, tickFormatter: (v) => (v / 1e3).toFixed(0) + "k" }),
              /* @__PURE__ */ jsx2(YAxis, { type: "category", dataKey: "label", fontSize: 11, width: 130 }),
              /* @__PURE__ */ jsx2(Tooltip, { formatter: (v) => v.toLocaleString() + " tokens" }),
              /* @__PURE__ */ jsx2(Bar, { dataKey: "context_length", fill: "#ffc658", name: "Contexte", isAnimationActive: false })
            ] }) }),
            /* @__PURE__ */ jsxs2("h2", { style: { marginTop: 32, color: "var(--ui-text-primary)" }, children: [
              "Radar comparatif (",
              currentProfile.name,
              ") (0–100)"
            ] }),
            /* @__PURE__ */ jsx2(ResponsiveContainer, { width: "100%", height: 450, children: /* @__PURE__ */ jsxs2(RadarChart, { data: radarData, children: [
              /* @__PURE__ */ jsx2(PolarGrid, {}),
              /* @__PURE__ */ jsx2(PolarAngleAxis, { dataKey: "label", fontSize: 11 }),
              /* @__PURE__ */ jsx2(PolarRadiusAxis, { angle: 90, domain: [0, 100], tick: false }),
              activeLabels.map((label) => {
                const ci = colorByLabel[label] ?? 0;
                return /* @__PURE__ */ jsx2(Radar, { dataKey: label, stroke: colors[ci % colors.length], fill: colors[ci % colors.length], fillOpacity: 0.12, isAnimationActive: false }, label);
              })
            ] }) }),
            /* @__PURE__ */ jsx2("div", { style: { display: "flex", justifyContent: "center", gap: 10, flexWrap: "wrap", marginTop: 12 }, children: allLabels.map((label) => {
    ...
    modalOpen && editingProfile && /* @__PURE__ */ jsx2("div", { style: {
      position: "fixed",
      top: 0,
      left: 0,
      right: 0,
      ...
      /* @__PURE__ */ jsxs2("div", { style: {
        ...
        /* @__PURE__ */ jsxs2("div", { style: { display: "flex", flexDirection: "column", gap: 4, alignItems: "flex-start" }, children: [
          /* @__PURE__ */ jsx2("h3", { style: { margin: 0, fontSize: 17, fontWeight: 700, color: "var(--ui-text-primary)" }, children: i18n.modal.configTitle(editingProfile.name) }),
          /* @__PURE__ */ jsxs2("div", { style: { display: "flex", gap: 10, alignItems: "center" }, children: [
            /* @__PURE__ */ jsx2(
              "button",
              {
                ...
                children: i18n.modal.autoFill
              }
            ),
            autoFillMsg ? /* @__PURE__ */ jsx2("span", { style: { fontSize: 12, color: "var(--ui-text-tertiary)" }, children: autoFillMsg }) : null
          ] })
        ] }),
        /* @__PURE__ */ jsx2(
          "button",
      ...
      /* @__PURE__ */ jsxs2("div", { style: { padding: "16px 20px", overflowY: "auto", flex: 1 }, children: [
        /* @__PURE__ */ jsxs2("div", { style: { display: "flex", gap: 12, marginBottom: 16 }, children: [
          /* @__PURE__ */ jsxs2("div", { style: { flex: 1 }, children: [
            /* @__PURE__ */ jsx2("label", { style: { display: "block", fontSize: 12, fontWeight: 700, color: "var(--ui-text-secondary)", marginBottom: 4 }, children: "Identifiant technique :" }),
            /* @__PURE__ */ jsx2(
              "input",
              {
                type: "text",
          ...
          /* @__PURE__ */ jsxs2("div", { style: { flex: 1.5 }, children: [
            /* @__PURE__ */ jsx2("label", { style: { display: "block", fontSize: 12, fontWeight: 700, color: "var(--ui-text-secondary)", marginBottom: 4 }, children: "Nom affiché :" }),
            /* @__PURE__ */ jsx2(
              "input",
              {
                type: "text",
        ...
        /* @__PURE__ */ jsxs2("div", { style: { borderTop: "1px solid var(--ui-stroke-tertiary)", paddingTop: 12 }, children: [
          ...
          /* @__PURE__ */ jsx2("div", { style: { display: "flex", flexDirection: "column", gap: 10 }, children: AVAILABLE_CRITERIA.map((crit) => {
            ...
            return /* @__PURE__ */ jsxs2(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsx2("div", { style: { width: 28, fontSize: 18, textAlign: "center" }, children: crit.icon }),
                  /* @__PURE__ */ jsxs2("div", { style: { flex: 1, minWidth: 0 }, children: [
                    /* @__PURE__ */ jsxs2("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center" }, children: [
                      /* @__PURE__ */ jsx2("span", { style: { fontWeight: currentWeight > 0 ? 700 : 500, fontSize: 13, color: currentWeight > 0 ? "var(--ui-text-primary)" : "var(--ui-text-tertiary)" }, children: i18n.criteria[crit.key] || crit.label }),
                    ...
                    /* @__PURE__ */ jsx2("div", { style: { fontSize: 11, color: "var(--ui-text-tertiary)", marginTop: 2, textOverflow: "ellipsis", overflow: "hidden", whiteSpace: "nowrap" }, children: i18n.criteria["d_" + crit.key] || crit.desc }),
                    /* @__PURE__ */ jsx2(
                      "input",
                      {
                        type: "range",
      ...
      /* @__PURE__ */ jsxs2("div", { style: {
        ...
        /* @__PURE__ */ jsxs2("div", { style: { display: "flex", gap: 10 }, children: [
          /* @__PURE__ */ jsx2(
            "button",
            {
              onClick: () => setModalOpen(false),
          ...
          /* @__PURE__ */ jsx2(
            "button",
            {
              ...
              children: savingProfile ? i18n.modal.saving : i18n.modal.save
            }
          )
        ] })
      ] })
...
var plugin = {
  ...
  defaultEnabled: true,
  register(ctx) {
    setRest((path2, opts) => ctx.rest(path2, opts));
